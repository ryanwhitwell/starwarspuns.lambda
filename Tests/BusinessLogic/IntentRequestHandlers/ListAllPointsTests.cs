...
{
  public class ListAllPointsTests
  {
...
AccessToken = "TestAccessToken"
    ...
    {
      Mock<ILogger<ListAllPoints>> mockLogger = new Mock<ILogger<ListAllPoints>>();
      Mock<ISkillRequestValidator> mockSkillRequestValidator = new Mock<ISkillRequestValidator>();

      ListAllPoints sut = new ListAllPoints(mockLogger.Object, mockSkillRequestValidator.Object);

      Assert.IsType<ListAllPoints>(sut);
    }
    ...
    public void Ctor_ShouldThrowArgumentNullException_WhenLoggerIsNull()
    {
      ...
      Assert.Throws<ArgumentNullException>(() => new ListAllPoints(null, mockSkillRequestValidator.Object));
    }
    ...
    public void Ctor_ShouldThrowArgumentNullException_WhenSkillRequestValidatorIsNull()
    {
      ...
      Assert.Throws<ArgumentNullException>(() => new ListAllPoints(mockLogger.Object, null));
    }
