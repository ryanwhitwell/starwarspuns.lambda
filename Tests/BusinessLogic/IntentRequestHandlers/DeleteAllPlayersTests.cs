...
{
  public class DeleteAllPlayersTests
  {
...
AccessToken = "TestAccessToken"
    ...
    {
      Mock<ILogger<DeleteAllPlayers>> mockLogger = new Mock<ILogger<DeleteAllPlayers>>();
      Mock<ISkillRequestValidator> mockSkillRequestValidator = new Mock<ISkillRequestValidator>();

      DeleteAllPlayers sut = new DeleteAllPlayers(mockLogger.Object, mockSkillRequestValidator.Object);

      Assert.IsType<DeleteAllPlayers>(sut);
    }
    ...
    public void Ctor_ShouldThrowArgumentNullException_WhenLoggerIsNull()
    {
      ...
      Assert.Throws<ArgumentNullException>(() => new DeleteAllPlayers(null, mockSkillRequestValidator.Object));
    }
    ...
    public void Ctor_ShouldThrowArgumentNullException_WhenSkillRequestValidatorIsNull()
    {
      ...
      Assert.Throws<ArgumentNullException>(() => new DeleteAllPlayers(mockLogger.Object, null));
    }
