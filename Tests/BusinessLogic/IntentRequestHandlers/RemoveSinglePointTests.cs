...
{
  public class RemoveSinglePointTests
  {
...
AccessToken = "TestAccessToken"
    ...
    {
      Mock<ILogger<RemoveSinglePoint>> mockLogger = new Mock<ILogger<RemoveSinglePoint>>();
      Mock<ISkillRequestValidator> mockSkillRequestValidator = new Mock<ISkillRequestValidator>();

      RemoveSinglePoint sut = new RemoveSinglePoint(mockLogger.Object, mockSkillRequestValidator.Object);

      Assert.IsType<RemoveSinglePoint>(sut);
    }
    ...
    public void Ctor_ShouldThrowArgumentNullException_WhenLoggerIsNull()
    {
      ...
      Assert.Throws<ArgumentNullException>(() => new RemoveSinglePoint(null, mockSkillRequestValidator.Object));
    }
    ...
    public void Ctor_ShouldThrowArgumentNullException_WhenSkillRequestValidatorIsNull()
    {
      ...
      Assert.Throws<ArgumentNullException>(() => new RemoveSinglePoint(mockLogger.Object, null));
    }
